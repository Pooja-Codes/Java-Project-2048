package com.poojapatel.main2048.game;
...
import com.poojapatel.main2048.gameobject.GameObject;
...
public class Game {
	...
	private void movingLogic() {
		...
		if(!moving && !hasMoved) {
			if(Main.highestTile==2048) {
				Main.createMessageBox("You Won! Game Over!");
				Main.wait(4000);
				System.exit(0);
			}
	...
	private void spawn() {
		// TODO Auto-generated method stub
		if(objects.size()==16) {
			Main.createMessageBox("Game Over! Try Again!");
			Main.wait(4000);
			System.exit(0);
		}
